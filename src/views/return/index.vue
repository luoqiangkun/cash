      ...
      <el-table :data="orderListsData.items" style="width: 100%" row-class-name="custom" :show-header="false">
         <el-table-column  width="20">
           <template slot-scope="scope">
             ...
             <i class="info" v-else-if="scope.row.order_status == 7"></i>
        ...
        <el-table-column label="操作" fixed="right" align="right" min-width="180px">
          <template slot-scope="scope" >
            <div class="coner">
            <el-button type="danger" @click="handleDetail(scope.$index, scope.row)" round v-if="scope.row.order_status == 1">查看详情</el-button>
            <el-button type="info" @click="handleDetail(scope.$index, scope.row)" round v-else-if="scope.row.order_status == 7">查看详情</el-button>
            <el-button type="primary" @click="handleDetail(scope.$index, scope.row)" round v-else>查看详情</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { orderLists,statusLists  } from '@/api/order'
